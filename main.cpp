...
const string assetDirectory = "/Users/shivumkapoor/Desktop/College/CS32/Project3/PeachParty/Assets";

class GameWorld;

GameWorld* createStudentWorld(string assetPath = "");

int main(int argc, char* argv[]) //clang++ Actor.cpp CoinSquare.cpp GameController.cpp GameWorld.cpp main.cpp PlayerAvatar.cpp StudentWorld.cpp -o PeachParty
{
